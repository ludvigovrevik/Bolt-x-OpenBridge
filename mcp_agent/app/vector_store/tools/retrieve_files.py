...
def retrieve_files(
    ...
    """
    Retrieve file metadata from a specific artifact based on a query.
    ...
    Returns:
        List[Dict[str, Any]]: A list of file metadata matching the query.
    """
    try:
        ...
        logger.error(f"Error retrieving files for query '{query}' in artifact '{artifact_id}': {e}")
        return []
